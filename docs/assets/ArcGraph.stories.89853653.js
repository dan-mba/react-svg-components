var u=Object.defineProperty;var p=(o,e)=>u(o,"name",{value:e,configurable:!0});import{p as n}from"./index.d9fbabd1.js";import{i as f}from"./percentage.74b6045d.js";import{a as g,j as a}from"./jsx-runtime.96b8dfe1.js";import"./iframe.fdda414e.js";const h="_progress_lodek_7",b="_animate_lodek_1",x="_move_lodek_14",k="_percentage_lodek_19",t={progress:h,animate:b,move:x,percentage:k},c=p(({size:o,percentage:e,color:l,backgroundColor:i,textColor:d})=>{if(typeof e!="number"||e<0||e>100)return null;const r=200*Math.PI,m=e/100*r;return g("svg",{xmlns:"http://www.w3.org/2000/svg",width:o,height:o*.5,viewBox:"0 0 240 120",children:[a("circle",{cx:"120",cy:"123",r:"100",fill:"none",strokeWidth:"25",strokeDasharray:`${r*.5} ${r}`,strokeLinecap:"butt",stroke:i,className:t.move}),a("circle",{cx:"120",cy:"123",r:"100",fill:"none",strokeWidth:"25",stroke:l,strokeDasharray:`${m*.5} ${r}`,strokeLinecap:"butt",className:`${t.progress} ${t.move}`}),a("text",{x:"125",y:"115",fill:d,className:t.percentage,children:`${e}%`})]})},"CircleGraph");c.defaultProps={size:500,color:"blue",backgroundColor:"#efefef",textColor:"black"};c.propTypes={size:n.exports.number,percentage:f,color:n.exports.string,backgroundColor:n.exports.string,textColor:n.exports.string};const s=c;c.__docgenInfo={description:"",methods:[],displayName:"CircleGraph",props:{size:{defaultValue:{value:"500",computed:!1},type:{name:"number"},required:!1,description:""},color:{defaultValue:{value:"'blue'",computed:!1},type:{name:"string"},required:!1,description:""},backgroundColor:{defaultValue:{value:"'#efefef'",computed:!1},type:{name:"string"},required:!1,description:""},textColor:{defaultValue:{value:"'black'",computed:!1},type:{name:"string"},required:!1,description:""},percentage:{type:{name:"custom",raw:"function isPercentage(props, propName, componentName) {\n  if(typeof props[propName] === 'number') {\n    if(props[propName] < 0 || props[propName] > 100) {\n      return new Error(`Invalid prop ${propName} passed to ${componentName}. Expected a number between 0 - 100`);\n    }\n  } else {\n    return new Error(`Invalid prop ${propName} passed to ${componentName}. Expected a number`);\n  }\n}"},required:!1,description:""}}};const A={parameters:{storySource:{source:`import AG from './ArcGraph';
