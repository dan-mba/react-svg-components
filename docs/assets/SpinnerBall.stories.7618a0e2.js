...
`,locationsMap:{"spinner-ball":{startLoc:{col:17,line:26},endLoc:{col:43,line:26},startBody:{col:17,line:26},endBody:{col:43,line:26}}}}},title:"Components/SpinnerBall",component:a,argTypes:{size:{description:"width & height of graph",default:200},primaryColor:{description:"primary color for spinner",control:"color"},secondaryColor:{description:"secondary color for spinner",control:"color"},duration:{description:"duration of spinning animation",default:"3s"}}},f=o(e=>s(a,{...e}),"Template"),g=f.bind({});g.args={size:200,primaryColor:"blue",secondaryColor:"#eeeeee",duration:"3s"};const _=["SpinnerBall"];export{g as SpinnerBall,_ as __namedExportsOrder,C as default};
//# sourceMappingURL=SpinnerBall.stories.7618a0e2.js.map
