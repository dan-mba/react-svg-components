var f=Object.defineProperty;var a=(r,e)=>f(r,"name",{value:e,configurable:!0});import{p as o}from"./index-50ee27ec.js";import{i as u}from"./percentage-0b4677c6.js";import{a as g,j as t}from"./jsx-runtime-61c49240.js";import"./index-eaecf2ca.js";import"./es.object.get-own-property-descriptor-8d92205a.js";const h="_progress_m90ct_7",C="_animate_m90ct_1",b="_move_m90ct_14",x="_percentage_m90ct_19",n={progress:h,animate:C,move:b,percentage:x},c=a(({size:r=500,percentage:e,color:s="blue",backgroundColor:i="#efefef",textColor:d="black"})=>{if(typeof e!="number"||e<0||e>100)return null;const l=200*Math.PI,m=e/100*l;return g("svg",{xmlns:"http://www.w3.org/2000/svg",width:r,height:r,viewBox:"0 0 230 230",children:[t("circle",{cx:"115",cy:"115",r:"100",fill:"none",strokeWidth:"25",stroke:i,className:n.move}),t("circle",{cx:"115",cy:"115",r:"100",fill:"none",strokeWidth:"25",stroke:s,strokeDasharray:`${m} ${l}`,strokeLinecap:"butt",className:`${n.progress} ${n.move}`}),t("text",{x:"120",y:"130",fill:d,className:n.percentage,children:`${e}%`})]})},"CircleGraph$1");c.propTypes={size:o.number,percentage:u,color:o.string,backgroundColor:o.string,textColor:o.string};const p=c;c.__docgenInfo={description:"",methods:[],displayName:"CircleGraph",props:{size:{defaultValue:{value:"500",computed:!1},type:{name:"number"},required:!1,description:""},color:{defaultValue:{value:"'blue'",computed:!1},type:{name:"string"},required:!1,description:""},backgroundColor:{defaultValue:{value:"'#efefef'",computed:!1},type:{name:"string"},required:!1,description:""},textColor:{defaultValue:{value:"'black'",computed:!1},type:{name:"string"},required:!1,description:""},percentage:{type:{name:"custom",raw:"function isPercentage(props, propName, componentName) {\n  if(typeof props[propName] === 'number') {\n    if(props[propName] < 0 || props[propName] > 100) {\n      return new Error(`Invalid prop ${propName} passed to ${componentName}. Expected a number between 0 - 100`);\n    }\n  } else {\n    return new Error(`Invalid prop ${propName} passed to ${componentName}. Expected a number`);\n  }\n}"},required:!1,description:""}}};const T={parameters:{storySource:{source:`import CG from './CircleGraph';
...
//# sourceMappingURL=CircleGraph.stories-1ece5698.js.map
